...
class User_model extends Model
{
    ...
    protected $editUser = 'http://10.148.15.251:8961/user/editprofile';
    protected $editUserPassReset = 'http://10.148.15.251:8961/user/resetpassword';

    protected $editUserVaultPin = 'http://10.148.15.251:8961/user/updatesafepassword';
    protected $userUpline = 'http://10.148.15.251:8961/user/getuplinename';
    protected $userUplineContact = 'http://10.148.15.251:8961/user/getuplinecontact';

    protected $user2ndPass = 'http://10.148.15.251:8961/user/checksecurepassword';
    protected $compareUser2ndPass = 'http://10.148.15.251:8961/user/comparesecurepassword';
    protected $editUser2ndPass = 'http://10.148.15.251:8961/user/updatesecurepassword';

    protected $getProfileWithoutLogin = 'http://10.148.15.251:8961/user/getprofileby';
    protected $getLoginId = 'http://10.148.15.251:8961/user/getloginid';

    protected $adminLink = 'http://10.148.15.251:8961/adminlink/getadminlink';
    ...
    public function selectLoginId($where)
    {
        $data = array_merge(['lang'=>$_SESSION['lang']], $where);
        $payload = json_encode($data);

        $ch = curl_init($this->getLoginId);
    ...
    public function selectUserWithoutLogin($where)
    {
        $data = array_merge(['lang'=>$_SESSION['lang'], 'agentid'=>$_ENV['host']], $where);
        $payload = json_encode($data);

        $ch = curl_init($this->getProfileWithoutLogin);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 30);
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $payload);
